...
namespace NuLog.Extensions.Console
{
    /// <summary>
    /// Extends the simple logger with methods for logging with console colors
    /// </summary>
    public static class ConsoleLoggerExt
    {
        ...
        public static void AddColors(LogEvent logEvent, ConsoleColor backgroundColor, ConsoleColor foregroundColor)
        {
            if (logEvent != null)
            {
                ...
                logEvent.MetaData[ConsoleTarget.MetaBackground] = backgroundColor;
                logEvent.MetaData[ConsoleTarget.MetaForeground] = foregroundColor;
            }
        }
        ...
        public static IDictionary<string, object> AddColors(IDictionary<string, object> metaData, ConsoleColor backgroundColor, ConsoleColor foregroundColor)
        {
            ...
            metaData[ConsoleTarget.MetaBackground] = backgroundColor;
            metaData[ConsoleTarget.MetaForeground] = foregroundColor;
