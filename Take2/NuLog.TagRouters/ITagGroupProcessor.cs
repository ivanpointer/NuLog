...
namespace NuLog.TagRouters
{
    ...
    public interface ITagGroupProcessor
    {
        ...
        /// 
        /// For example, if you were implementing a level based logging strategy (legacy), you'd expect the "fatal" tag to also match for rules expecting "error", "warn", "info", "debug" and "trace".
        /// </summary>
